...
const Teams = () => {
  return (
    <div
      className="w-full h-full grid grid-cols-4 px-5 py-2 backdrop-blur-[3px] border-1 border-[#6a728226] bg-[#78727226]"
    >
     ...
     md:col-span-4  "
      >
        <img
          ...
          alt=""
          className="h-[190px] w-[80%] lg:w-full lg:h-[280px] md:h-[350px]  rounded-2xl"
        />
      </div>
    </div>
  );
